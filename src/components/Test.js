...
// const adminSocket = io("mongo-db-backend-production.up.railway.app/admin");
...
const adminSocket = io("mongo-db-backend-production.up.railway.app/");
...
//       try {
//         const uploadResponse = await axios.post("mongo-db-backend-production.up.railway.app//api/upload", formData, {
//           headers: { "Content-Type": "multipart/form-data" },
//         });
